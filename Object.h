...
/**
 * Convert a Purrscal string to an equivalent C++ string.
 * @parm purrscalString the Purrscal string.
 * @parm needBackslash true if need to backslash-quote double-quotes
 * @return the C++ string.
 */
inline string convertString(const string purrscalString, bool needBackslash)
{
