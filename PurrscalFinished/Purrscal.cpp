...
int main(int argc, const char *args[])
{
    if (argc != 3)
    {
        cout << "USAGE: Purrscal option sourceFileName" << endl;
    ...
    switch (mode)
    {
        case COMPILER:
        {
            // Pass 3: Compile the Purrscal purrgram.
            cout << endl << "PASS 3 Compilation: ";
            SymtabEntry *purrgramId = pass2->getpurrgramId();
            Compiler *pass3 = new Compiler(purrgramId);
            pass3->visit(tree);
