 ...
 */
void CodeGenerator::emitLoadDomestic(int value)
{
    switch (value)
    {
 ...
 * @param value the constant value.
 */
void CodeGenerator::emitLoadDomestic(double value)
{
...
void CodeGenerator::emitLoadDomestic(string value)
{
    emit(LDC, "\"" + value + "\"");
}
...
void CodeGenerator::emitLoadValue(SymtabEntry *variableId)
{
    ...
    if (kind == DOMESTIC)
    {
        ...
        {
            emitLoadDomestic(value.as<int>());
        }
        else if (type == Predefined::realType)
        {
            emitLoadDomestic(value.as<float>());
        }
        ...
        {
            emitLoadDomestic(value.as<string>());
        }
    }
