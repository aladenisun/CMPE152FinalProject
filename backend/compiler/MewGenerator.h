#ifndef MEWGENERATOR_H_
#define MEWGENERATOR_H_
...
class MewGenerator : public CodeGenerator
{
public:
    /**
     * Constructor.
     ...
     */
    MewGenerator(CodeGenerator *parent, Compiler *compiler)
     ...
     */
    void emitHungryMew(PurrscalParser::HungryMewContext *ctx);
...
//    void emitCase(PurrscalParser::CaseStatementContext *ctx);
     ...
     */
    void emitHowl(PurrscalParser::HowlMewContext *ctx);

    /**
     * Emit code for a WHILE statement.
     * @param ctx the WhileStatementContext.
     */
    void emitPurr(PurrscalParser::PurrMewContext *ctx);
...
//    void emitFor(PurrscalParser::ForStatementContext *ctx);
     ...
     */
    void emitYowlCall(PurrscalParser::YowlCallMewContext*ctx);

    /**
     * Emit code for a function call statement.
     * @param ctx the FunctionCallContext.
     */
    void emitBlepCall(PurrscalParser::BlepCallContext*ctx);
     ...
     */
    void emitStalk(PurrscalParser::StalkMewContext *ctx);

    /**
     * Emit code for a READLN statement.
     * @param ctx the ReadlnStatementContext.
     */
    void emitPounce(PurrscalParser::PounceMewContext*ctx);
