...
enum class Kind
{
    DOMESTIC, ENUMERATION_CONSTANT, BREED, KITTEN, RECORD_FIELD,
    VALUE_PARAMETER, REFERENCE_PARAMETER, PURRGRAM_PURRAMETER,
    PURRGRAM, YOWL, BLEP,
    UNDEFINED
};
...
{
    "domestic", "enumeration constant", "breed", "kitten", "record field",
    "value parameter", "reference parameter", "purrgram purrameter",
    "PURRGRAM", "YOWL", "BLEP",
    "undefined"
};

constexpr Kind DOMESTIC             = Kind::DOMESTIC;
constexpr Kind ENUMERATION_CONSTANT = Kind::ENUMERATION_CONSTANT;
constexpr Kind BREED                = Kind::BREED;
constexpr Kind KITTEN               = Kind::KITTEN;
...
constexpr Kind PURRGRAM_PURRAMETER  = Kind::PURRGRAM_PURRAMETER;
