...
void CodeGenerator::open(string purrgramName, string suffix)
{
    objectFileName = purrgramName + "." + suffix;
...
void CodeGenerator::emitLoadValue(SymtabEntry *variableId)
{
    ...
    else if (nestingLevel == 1)
    {
        ...
        string name = purrgramName + "/" + variableName;
                                                  ...
                                                  Typespec *targetType)
{
    ...
    if (nestingLevel == 1)
    {
        ...
        string name = purrgramName + "/" + targetName;
...
string CodeGenerator::typeDescriptor(Typespec *PurrscalType)
{
    ...
    while (form == ARRAY)
    {
        ...
        form = PurrscalType->getForm();
    }

    PurrscalType = PurrscalType->baseType();
    string str;

    if      (PurrscalType == Predefined::integerType) str = "I";
    else if (PurrscalType == Predefined::realType)    str = "F";
    else if (PurrscalType == Predefined::booleanType) str = "Z";
...
string CodeGenerator::objectTypeName(Typespec *PurrscalType)
{
    Form form = PurrscalType->getForm();
    string typeName;
    bool isArray = false;
    ...
    if      (PurrscalType == Predefined::integerType) str = "java/lang/Integer";
    else if (PurrscalType == Predefined::realType)    str = "java/lang/Float";
    else if (PurrscalType == Predefined::booleanType) str = "java/lang/Boolean";
