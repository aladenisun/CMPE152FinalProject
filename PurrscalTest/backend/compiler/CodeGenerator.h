...
public:
    /**
     * Constructor.
     * @param purrgramName the name of the purrgram.
     * @param suffix the suffix for the object file name.
     * @param compiler the compiler to use.
     */
    CodeGenerator(string purrgramName, string suffix, Compiler *compiler)
        : objectFile(nullptr), purrgramName(purrgramName),
          localVariables(nullptr), localStack(nullptr),
          compiler(nullptr)
	{
    	open(purrgramName, suffix);
	}
    ...
    CodeGenerator(CodeGenerator *parent, Compiler *compiler)
        : objectFile(parent->objectFile), purrgramName(parent->purrgramName),
     ...
     */
    void open(string purrgramName, string suffix);
     ...
     * a purrgram variable, a local variable, a constant, or a VAR parameter.
    ...
    /**
     * Return a type descriptor for a Purrscal datatype.
     * @param PurrscalType the datatype.
     * @return the type descriptor.
     */
    string typeDescriptor(Typespec *PurrscalType);

    /**
     * Return the Java object name for a Purrscal datatype.
     * @param PurrscalType the datatype.
     * @return the object name.
     */
    string objectTypeName(Typespec *PurrscalType);
...
private:
     ...
     * which can be a purrgram variable or a local variable.
