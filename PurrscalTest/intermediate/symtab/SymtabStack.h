...
private:
    ...
    SymtabEntry *purrgram_id;    // entry for the main purrgram id
...
public:
     ...
     * Constructor.
     */
    SymtabStack() : current_nesting_level(0), purrgram_id(nullptr)
    {
    ...
    /**
     * Getter.
     * @return the symbol table entry for the main purrgram identifier.
     */
    SymtabEntry *getPurrgramId() const { return purrgram_id; }

    /**
     * Setter.
     * @param entry the symbol table entry for the main purrgram identifier.
     */
    void setPurrgramId(SymtabEntry *id) { purrgram_id = id; }
